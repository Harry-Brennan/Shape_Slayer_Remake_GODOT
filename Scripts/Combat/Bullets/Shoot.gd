...
func shoot():
	if (can_shoot):
		...
		var instantiated_bullet : Bullet =  Bullet.new_bullet(1000,rng.randf_range(0, 100), global_position, global_rotation, is_enemy, Bullet_Movement.movement_types["homing"])
